...
$query = 'DELETE FROM `movie_users` WHERE `movie_users`.`id_movie_user` = '.$id_movie.' AND `movie_users`.`user_id` = '.$_SESSION["user_id"].'';
echo $query;
$result = mysqli_query($koneksi, $query);

$dataRequest = $http->http_request("api/user/movie", "DELETE", json_encode(array(
