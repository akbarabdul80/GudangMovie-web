...
<body>
	<center>
		<h2 class="text-2xl pt-10" style="color: white;">Movie Populer</h2>

		<div class="p-5">
			<td class="px-6 py-4"><a href="home.php" class="px-4 py-1 text-sm text-white bg-yellow-400 rounded">Home</a></td>
			<td class="px-6 py-4"><a href="movie-populer.php" class="px-4 py-1 text-sm text-white bg-green-400 rounded">Populer</a></td>
					...
					<div class="border-b border-gray-200 shadow">
						<table>
							...
							<tbody class="bg-white">
                                ...
                                $data_json = $http->http_request("popular", "GET", "");
